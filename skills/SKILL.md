...
| `get_app_reviews` | Fetch user reviews for any app with pagination | 1 × reviews returned |
...
| `review_analysis` | Sentiment analysis and review insights for an app |
...
| Reviews | [review-analysis](skills/review-analysis) | Sentiment, complaints, feature requests, cross-country feedback |
...
- “Compare reviews for the top 3 meditation apps in the US.”

Slash-style entry points: `/app-discovery`, `/keyword-research`, `/metadata-optimization`, `/competitor-analysis`, `/growth-analysis`, `/ad-intelligence`, `/revenue-analysis`, `/review-analysis`.
...
| `/api/v1/reviews` | POST | Fetch app reviews | 1 per review |
...
- **Reviews:** Individual reviews with star rating (1–5), title, body text, reviewer nickname, date, and country. Paginated via offset/nextOffset.
